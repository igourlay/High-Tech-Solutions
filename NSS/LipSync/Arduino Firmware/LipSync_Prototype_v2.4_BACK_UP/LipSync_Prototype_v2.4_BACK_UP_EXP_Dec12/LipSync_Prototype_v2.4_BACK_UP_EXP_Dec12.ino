...
int y_cursor_low(int j) {
  ...
  int k = (int)(round(-1.0*cursor_max_speed * (1.0 - pow(2.718, (cursor_factor * (((float)(y_center - j)) / y_center))))));
...
int x_cursor_high(int j) {
  ...
  int k = (int)(round(-1.0*cursor_max_speed * (1.0 - pow(2.718, (cursor_factor * (((float)(j - x_center)) / x_center))))));
...
int x_cursor_low(int j) {
  ...
  int k = (int)(round(cursor_max_speed * (1.0 - pow(2.718, (cursor_factor * (((float)(x_center - j)) / x_center))))));
...
void Joystick_Initialization(void) {
  ...
  box_delta = 45;                                 // ***CAN BE CHANGED TO CREATE MORE SENSITIVE MOVEMENT ACTIVATION *ORIGINALLY 25
