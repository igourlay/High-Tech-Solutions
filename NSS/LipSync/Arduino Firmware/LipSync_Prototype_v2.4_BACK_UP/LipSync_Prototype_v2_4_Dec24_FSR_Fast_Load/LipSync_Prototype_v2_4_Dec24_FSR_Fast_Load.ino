...
#define TRANS_CONTROL A3
#define PIO4 A4

#define PRESSURE_CURSOR A5                        // pressure sensor pin - analog input pin A5
#define X_DIR_HIGH A0                                   // PIO4 pin - digital output pin A4
#define X_DIR_LOW A1                          // transistor pin - digital output pin A3
#define Y_DIR_HIGH A2                            // joystick x-direction pin - analog input pin A2
#define Y_DIR_LOW A10                            // joystick y-direction pin - analog input pin A1
...
_cursor setting1 = {5, -1.0, 30}; // 5,-1.0,10
_cursor setting2 = {5, -1.2, 30}; // 5,-1.2,10
_cursor setting3 = {5, -1.4, 30}; //        10
_cursor setting4 = {5, -1.6, 30}; //        10
_cursor setting5 = {5, -1.8, 30}; //        10
...
void loop() {
  ...
  if (single == 0) {
    Serial.println(" ");
    Serial.println(" --- ");
    Serial.println("This is the 24 December - Stable Fast Start-Up FSR version.");
    Serial.println(" --- ");
...
void Joystick_Initialization(void) {
  ...
  box_delta = 20;                                 // ***CAN BE CHANGED TO CREATE MORE SENSITIVE MOVEMENT ACTIVATION *ORIGINALLY 25
