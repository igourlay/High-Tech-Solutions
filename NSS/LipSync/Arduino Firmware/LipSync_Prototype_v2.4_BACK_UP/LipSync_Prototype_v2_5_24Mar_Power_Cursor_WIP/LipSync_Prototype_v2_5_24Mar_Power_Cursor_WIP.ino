...
void loop() {
  ...
  if (single == 0) {
    Serial.println(" ");
    Serial.println(" --- ");
    Serial.println("This is the 24 March - FSR Experimental Exponential Cursor Algorithm WIP");
    Serial.println(" ");
...
void mouseCommand(int buttons, int x, int y, int scroll) {
  ...
  delay(40);    // reduced poll_counter delay by 30ms so increase delay(10) to delay (40)
}
