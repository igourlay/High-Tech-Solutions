...
_cursor setting1 = {5, -1.0, 50}; // 5,-1.0,10
_cursor setting2 = {5, -1.2, 50}; // 5,-1.2,10
_cursor setting3 = {5, -1.4, 50}; //        10
_cursor setting4 = {5, -1.6, 50}; //        10
_cursor setting5 = {5, -1.8, 50}; //        10
...
void setup() {
  ...
  Serial.println(init_counter);                   // Diagnostics - can be removed later

  //delay(2000);                                  // Diagnostics - not in final build
...
void loop() {
  ...
  if (single == 0) {
    Serial.println(" ");
    Serial.println(" --- ");
    Serial.println("This is the 29 December - Fast Start-Up Sequence version.");
    Serial.println(" --- ");
...
void Joystick_Initialization(void) {
  ...
  box_delta = 5;                                 // ***CAN BE CHANGED TO CREATE MORE SENSITIVE MOVEMENT ACTIVATION *ORIGINALLY 25
