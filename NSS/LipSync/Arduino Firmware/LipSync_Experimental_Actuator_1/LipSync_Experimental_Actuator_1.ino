...
_cursor setting1 = {5, -1.0, 10};
_cursor setting2 = {5, -1.2, 10};
_cursor setting3 = {5, -1.4, 10};
_cursor setting4 = {5, -1.6, 10};
_cursor setting5 = {5, -1.8, 10};
...
void setup() {
  ...
  Serial.println("This is the 25 October version.");
  Serial.println(" --- ");
...
int y_cursor_high(int j){
  ...
  int k = (int)(round(cursor_max_speed*(1.0-pow(2.718,(cursor_factor*((float)((j-y_center)-box_delta)/(20-box_delta)))))));
...
int y_cursor_low(int j){
  ...
  int k = (int)(round(-1.0*cursor_max_speed*(1.0-pow(2.718,(cursor_factor*((float)((y_center-j)-box_delta)/(20-box_delta)))))));
...
int x_cursor_high(int j){
  ...
  int k = (int)(round(-1.0*cursor_max_speed*(1.0-pow(2.718,(cursor_factor*((float)((j-x_center)-box_delta)/(20-box_delta)))))));
...
int x_cursor_low(int j){
  ...
  int k = (int)(round(cursor_max_speed*(1.0-pow(2.718,(cursor_factor*((float)((x_center-j)-box_delta)/(20-box_delta)))))));
