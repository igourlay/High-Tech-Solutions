...
#define X_DIRECTION A1                            //joystick x-direction pin
#define Y_DIRECTION A2                            //joystick y-direction pin
...
void loop() {
  ...
  x = analogRead(A0);                             //read x-direction value
  y = analogRead(A1);                             //read y-direction value
