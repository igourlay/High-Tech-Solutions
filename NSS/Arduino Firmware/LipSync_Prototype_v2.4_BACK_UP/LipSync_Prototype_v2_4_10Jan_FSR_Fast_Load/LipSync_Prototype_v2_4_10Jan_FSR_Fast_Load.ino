...
#define PUSH_BUTTON_UP 6                          // Cursor Control Button 1: UP - digital input pin 8 (internally pulled-up)
...
void setup() {
  ...
  blink(3, 500, 3);                               // end initialization visual feedback
...
void loop() {
  ...
  if (single == 0) {
    Serial.println(" ");
    Serial.println(" --- ");
    Serial.println("This is the 10 January - Stable Fast Start-Up FSR version.");
    Serial.println(" ");
