...
void setup() {
  ...
  //delay(600);   //***Needed to establish serial comms - in final build any serial feedback may not be necessary???
...
void loop() {
  ...
  if (single == 0) {
    Serial.println(" ");
    Serial.println(" --- ");
    Serial.println("This is the 30 November - Stable version.");
    Serial.println(" --- ");
