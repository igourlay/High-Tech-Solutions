...
_cursor setting1 = {5, -1.0, default_cursor_speed-(4*delta_cursor_speed)}; // 5,-1.0,10
_cursor setting2 = {5, -1.0, default_cursor_speed-(3*delta_cursor_speed)}; // 5,-1.2,10
_cursor setting3 = {5, -1.0, default_cursor_speed-(2*delta_cursor_speed)}; 
_cursor setting4 = {5, -1.0, default_cursor_speed+(delta_cursor_speed)}; 
_cursor setting5 = {5, -1.0, default_cursor_speed};
_cursor setting6 = {5, -1.0, default_cursor_speed+(delta_cursor_speed)};
_cursor setting7 = {5, -1.0, default_cursor_speed+(2*delta_cursor_speed)};
_cursor setting8 = {5, -1.0, default_cursor_speed+(3*delta_cursor_speed)};
_cursor setting9 = {5, -1.0, default_cursor_speed+(4*delta_cursor_speed)};
...
void setup() {
  ...
  blink(3, 250, 3);                               // end initialization visual feedback
...
void loop() {
  ...
  if (single == 0) {
    Serial.println(" ");
    Serial.println(" --- ");
    Serial.println("This is the 19 January - Stable Fast Start-Up FSR version [9 speed inc].");
    Serial.println(" ");
