...
void Pressure_Sensor_Initialization(void) {
  ...
  delay(20);
  sip_threshold = nominal_cursor_value + 0.25;    //create sip pressure threshold value ***Originally: +0.15
  delay(20);
  puff_threshold = nominal_cursor_value - 0.25;   //create puff pressure threshold value ***Originally: -0.15
  delay(20);
}
